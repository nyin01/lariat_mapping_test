...
SECONDS=0 
LOGFILE_PATH=larmap_out/logs/child_logs/larmap_WT_R2.out 
...
mkdir -p larmap_out/output/WT_R2 

printf "Beginning WT read two lariat mapping...\n"
scripts/map_lariats.sh \
demo_files/demo_fastq_files_250k_bp/250k_cWT_2.fq.gz \
larmap_out/output/WT_R2/WT_R2 \
4 \
...
printf "Mapping of WT read two file complete\n"
