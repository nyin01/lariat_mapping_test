...
SECONDS=0 
LOGFILE_PATH=larmap_out/logs/child_logs/larmap_Y17H_R2.out 
...
mkdir -p larmap_out/output/Y17H_R2 

printf "Beginning Y17H read two lariat mapping...\n"
scripts/map_lariats.sh \
demo_files/demo_fastq_files_250k_bp/250k_cDBR1-Y17H_2.fq.gz \
larmap_out/output/Y17H_R2/Y17H_R2 \
4 \
...
printf "Mapping of Y17H read two file complete\n"
